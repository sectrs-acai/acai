...
export OUTPUT_LINUX_GUEST_HEADERS=$OUTPUT_LINUX_GUEST_DIR/build/linux-headers-custom
export OUTPUT_LINUX_HOST_HEADERS=$OUTPUT_LINUX_HOST_DIR/build/linux-headers-custom
